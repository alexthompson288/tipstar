...
class StarsControllerTest < ActionController::TestCase
  ...
  test "should create star" do
    assert_difference('Star.count') do
      post :create, star: { dog: @star.dog, item_id: @star.item_id, tipstar: @star.tipstar, user_id: @star.user_id }
    end
  ...
  test "should update star" do
    patch :update, id: @star, star: { dog: @star.dog, item_id: @star.item_id, tipstar: @star.tipstar, user_id: @star.user_id }
    assert_redirected_to star_path(assigns(:star))
  end
